...
Type `/outcome-vocabulary`, or the agent reaches for it on its own when a task fits. [create-personas-and-job-stories](https://euxlab.com/system/skills/create-personas-and-job-stories) and [design-brief](https://euxlab.com/system/skills/design-brief) both load it, so inside the loop you rarely type it yourself.
...
For grading the evidence under a statement instead, use [evidence-standards](https://euxlab.com/system/skills/evidence-standards).
...
- [create-personas-and-job-stories](https://euxlab.com/system/skills/create-personas-and-job-stories) writes job stories and desired outcomes per transcript, because it needs the strict grammar to keep them solution-free.
- [design-brief](https://euxlab.com/system/skills/design-brief) uses outcome statements, because each requirement has to state what it makes observable before design starts.
