...
Type `/euxlab-evidence-standards`, or the agent reaches for it on its own when a task fits. [euxlab-grill-the-ask](https://euxlab.com/system/skills/euxlab-grill-the-ask), [euxlab-create-personas-and-job-stories](https://euxlab.com/system/skills/euxlab-create-personas-and-job-stories), [euxlab-synthesize](https://euxlab.com/system/skills/euxlab-synthesize), [euxlab-design-brief](https://euxlab.com/system/skills/euxlab-design-brief) and [euxlab-design-review](https://euxlab.com/system/skills/euxlab-design-review) all load it, so inside the loop you rarely type it yourself.
...
For judging whether a design fits an enterprise context instead, use [euxlab-enterprise-ux-stance](https://euxlab.com/system/skills/euxlab-enterprise-ux-stance).
...
No. It is untested. [euxlab-grill-the-ask](https://euxlab.com/system/skills/euxlab-grill-the-ask) turns every C and D into an interview question, or into a written decision to accept the risk untested.
...
- [euxlab-synthesize](https://euxlab.com/system/skills/euxlab-synthesize) applies it to every insight, because the weakest-grade rule decides how strong each insight is.
- [euxlab-design-review](https://euxlab.com/system/skills/euxlab-design-review) uses it for the Evidence review, because that review asks of every screen which insight it serves and where that is written, then reports the grade at the source of each trace chain.
