...
Type `/enterprise-ux-stance`, or the agent reaches for it on its own when a task fits. [design-review](https://euxlab.com/system/skills/design-review) loads it for the Standards review. [grill-the-ask](https://euxlab.com/system/skills/grill-the-ask) and [design-brief](https://euxlab.com/system/skills/design-brief) cite single smells from it. Inside the loop you rarely type it yourself.
...
For grading the evidence behind a decision instead, use [evidence-standards](https://euxlab.com/system/skills/evidence-standards).
...
Constraint-led innovation treats a mandated design system, a locked platform, or an immovable regulation as the shape of the problem. A solution that needs the constraint to lift is not a solution. This is why [setup-euxlab-skills](https://euxlab.com/system/skills/setup-euxlab-skills) records your design system as binding.
...
- [design-review](https://euxlab.com/system/skills/design-review) checks every screen against the ten smells, because the Standards review needs a baseline even when the engagement documents none.
- [evidence-standards](https://euxlab.com/system/skills/evidence-standards) takes over for solution-shaped research, because grading evidence is its job.
